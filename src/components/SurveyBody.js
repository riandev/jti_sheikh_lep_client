...
const SurveyBody = () => {
  ...
  const handleSearch = () => {
    fetch(`http://192.168.10.11:5055/dMatched/${searchNumber}`)
      .then((res) => res.json())
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`http://192.168.10.11:5055/answers/${consumer?._id}`, {
      method: "PATCH",
  ...
  return (
    <div>
      ...
      >
        <h6>
          ৭. সে কি আপনাকে সীমিত সময়ের শেখের নতুন প্যাক ও স্টিক এর ব্যাপারে
          জানিয়েছে/দেখিয়েছে?
        </h6>
      ...
      >
        <h6>
          ১১.১ আপনি কি সিগারেট রাখার জন্য প্লাস্টিকের বক্স/স্যাশে পেয়েছেন?
        </h6>
      ...
      <div
        ...
        className="mt-2"
      >
        <h6>১১.২ আপনি কি কোন লাইটার সহ বক্স পেয়েছেন?</h6>
