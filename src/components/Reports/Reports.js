...
const Reports = () => {
  ...
  useEffect(() => {
    fetch("http://192.168.10.11:5055/reports")
      .then((res) => res.json())
      .then((data) => {
        setReport(data);
      });
  ...
  useEffect(() => {
    fetch("http://192.168.10.11:5055/reportDates")
      .then((res) => res.json())
  ...
  function handlePrepare(pdate) {
    console.log(pdate);
    fetch("http://192.168.10.11:5055/prepareByDate?date=" + pdate)
      .then((res) => res.json())
  ...
  let headers = [
    ...
    { label: "q11dot1", key: "answer11dot1" },
    { label: "q11dot2", key: "answer11dot2" },
